...
void render::init( ) {
	...
	slider     = Font( XOR( "Verdana" ), 12, FW_BOLD, FONTFLAG_ANTIALIAS );
	esp        = Font( XOR( "Verdana" ), 12, FW_NORMAL, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW );
	esp_small  = Font( XOR( "Small Fonts" ), 8, FW_NORMAL, FONTFLAG_ANTIALIAS | FONTFLAG_OUTLINE);
	hud        = Font( XOR( "Verdana" ), 12, FW_NORMAL, FONTFLAG_DROPSHADOW );
	indicator  = Font( XOR( "Verdana" ), 26, FW_BOLD, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW );
	console    = Font( XOR( "Lucida Console" ), 10, FW_NORMAL, FONTFLAG_DROPSHADOW);
	...
	icon	   = Font( XOR( "undefeated" ), 16, FW_MEDIUM, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);

	undefeated = Font(XOR("undefeated"), 25, FW_NORMAL, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	boldVerdana = Font(XOR("boldVerdana"), 12, FW_BOLD, FONTFLAG_ANTIALIAS);
...
void render::TexturedPolyline(int n, std::vector<Vertex> vertice, Color color)
{
