...
public:
	...
	__forceinline vec3_t& ViewOffset() {
		return get< vec3_t >(g_entoffsets.ViewOffset);
	}
	...
	__forceinline bool& m_bBombDefused() {
		return get< bool >(g_entoffsets.m_bBombDefused);
	}
	...
	__forceinline int& m_nBombSite() {
		return get< int >(g_entoffsets.m_nBombSite);
	}
	...
	__forceinline float& m_flDefuseCountDown() {
		return get< float >(g_entoffsets.m_flDefuseCountDown);
	}

	__forceinline int& m_hBombDefuser() {
		return get< int >(g_entoffsets.m_hBombDefuser);
	}

	__forceinline float& m_flDefuseLength() {
		return get< float >(g_entoffsets.m_flDefuseLength);
	}
