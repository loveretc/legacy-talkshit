...
public:
    ...
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > ViewOffset;
    ...
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_flDefuseLength;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_bombsiteCenterA;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_bombsiteCenterB;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_flDefuseCountDown;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_nBombSite;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_hBombDefuser;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_bBombDefused;
    ...
    void init( ) {
        ...
        INIT_XOREDNETVAR( ViewOffset,                  HASH( "DT_BasePlayer"),            HASH("m_vecViewOffset[0]"));
        ...
        INIT_XOREDNETVAR( m_bBombDefused,               HASH( "DT_PlantedC4" ),            HASH( "m_bBombDefused" ));
        INIT_XOREDNETVAR( m_flC4Blow,                   HASH( "DT_PlantedC4" ),            HASH( "m_flC4Blow" ) );
        INIT_XOREDNETVAR( m_nBombSite,                  HASH( "DT_PlantedC4"),             HASH( "m_nBombSite" ) );
        INIT_XOREDNETVAR( m_bBombTicking,               HASH( "DT_PlantedC4" ),            HASH( "m_bBombTicking" ) );
        INIT_XOREDNETVAR( m_flDefuseCountDown,          HASH( "DT_PlantedC4" ),            HASH( "m_flDefuseCountDown" ));
        INIT_XOREDNETVAR( m_hBombDefuser,               HASH( "DT_PlantedC4"),             HASH("m_hBombDefuser"));
        INIT_XOREDNETVAR( m_flDefuseLength,             HASH("DT_PlantedC4"),              HASH("m_flDefuseLength"));
        INIT_XOREDNETVAR(m_bombsiteCenterA,             HASH("DT_CSPlayerResource"),              HASH("m_bombsiteCenterA"));
        INIT_XOREDNETVAR(m_bombsiteCenterB,             HASH("DT_CSPlayerResource"),              HASH("m_bombsiteCenterB"));
