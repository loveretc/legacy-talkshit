...
//}
//
//void c_grenade_pred::on_create_move(CUserCmd* cmd) {
//    m_data = {};
//
...
//
//
//    return &g_visuals.m_weapon_icons[index];
//
//    switch (index)
//    {
//    case SMOKE: return "k"; break;
//    case HEGRENADE: return "j"; break;
//    case MOLOTOV:return "H"; break;
//    case 48:return "H"; break;
//    }
//
//
//    return "";
//}
//
//bool c_grenade_pred::data_t::draw() const
//{
//    if (!g_menu.main.visuals.grenade_proximity_warning.get())
//        return false;
//
...
//    draw_arc(prev_screen.x, prev_screen.y, 20, 0, 360 * percent, 2, Color(255, 255, 255, 225));
//    render::icon.string(prev_screen.x, prev_screen.y - render::icon.size(icon).m_height / 2.f, { 255,255,255,255 }, icon, render::ALIGN_CENTER);
//    // }
//
...
//            render::icon.string(position.x, position.y - render::icon.size(icon).m_height / 2.f, { 255,255,255,255 }, icon, render::ALIGN_CENTER);
//        }
//
//    }
//    return true;
//}
//
//void c_grenade_pred::grenade_warning(Player* entity)
//{
//    auto& predicted_nades = g_grenades_pred2.get_list();
//
